...
public class OrderController {
    ...
    @PostMapping(PUBLIC_BASE_ORDER_PATH + APPEND_CC_PAYMENT_PATH + APPEND_ORDER_PATH)
    public ResponseEntity<OrderDTO> orderProductsViaCC(@PathVariable String email, @PathVariable Long cartId, @Valid @RequestBody CCPaymentDTO ccPaymentDTO) {
        OrderDTO order = orderService.placeOrderViaCreditCard(email, cartId, ccPaymentDTO);
