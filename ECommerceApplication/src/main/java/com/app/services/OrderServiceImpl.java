...
public class OrderServiceImpl implements OrderService {
	...
	@Autowired
	public VCCPaymentInfoRepo vccPaymentInfoRepo;
	...
	public OrderDTO placeOrderViaCreditCard(String email, Long cartId, CCPaymentDTO ccPaymentDTO) {
		...
		buildAndSaveVCCPaymentInfo(ccPaymentDTO, payment);
	...
	public void buildAndSaveVCCPaymentInfo(CCPaymentDTO ccPaymentDTO, Payment payment) {
		VCCPaymentInfo vccPaymentInfo = VCCPaymentInfo.builder()
				.cardNumber(ccPaymentDTO.getCardNumber())
				.payment(payment)
				.cvv(ccPaymentDTO.getCvv())
				.build();

		vccPaymentInfoRepo.save(vccPaymentInfo);
	}
}
